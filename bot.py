...
def send_test_message():
    ...
    send_telegram("🧪 <b>TEST v24 — Alerta 1</b>\n\n" +
                  format_detection_alert("BTCUSDT", "4H", detection, levels, score))
    time.sleep(2)
    send_telegram("🧪 <b>TEST v24 — Alerta 2: CHoCH confirmado</b>\n\n" +
...
# ─── MAIN ────────────────────────────────────────────────────
def main():
    print("🤖 Bot TTrades v24 — PRO Edition")
    ...
    send_telegram(
        "🤖 <b>Bot TTrades AMD v24 — PRO EDITION</b>\n\n"
