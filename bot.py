...
def send_test_message():
    ...
    send_telegram("🧪 <b>TEST v34 — Alerta 1</b>\n\n" +
                  format_detection_alert("BTCUSDT", "4H", detection, levels, score))
    time.sleep(2)
    send_telegram("🧪 <b>TEST v34 — Alerta 2: CHoCH confirmado</b>\n\n" +
...
# ─── MAIN ────────────────────────────────────────────────────
def main():
    print("🤖 Bot TTrades v34 — PRO Edition")
    ...
    send_telegram(
        "🤖 <b>Bot TTrades AMD v34 — PRO Edition + CHoCH Retroactivo</b>\n\n"
